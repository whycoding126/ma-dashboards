 ...
 *
 */
public class PublicUrlHandler implements UrlHandler{
	
	private String dashboardsBasePath;
	
	public PublicUrlHandler(String modulePath){
		this.dashboardsBasePath = modulePath + Lifecycle.publicFilesLocation;
	}
	...
	public View handleRequest(HttpServletRequest request,
		...
		String[] parts = contextPath.split(Lifecycle.publicUrlPrefix);
