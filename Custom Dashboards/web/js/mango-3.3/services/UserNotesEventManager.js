...
/**
* @ngdoc service
* @name maServices.UserNotesEventManager
*
* @description
...
function UserNotesEventManager(EventManager) {
    return new EventManager({
    	url: '/rest/v1/websocket/comments'
    });
}

UserNotesEventManager.$inject = ['EventManager'];
return UserNotesEventManager;
