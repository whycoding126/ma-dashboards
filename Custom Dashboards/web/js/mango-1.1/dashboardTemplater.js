...
define(['jquery', './select', './dateTimePicker', './rollupPicker', './timePeriodTypePicker', './input',
        './dataDisplayManager', './dataPointMatcher', './api', './pointHierarchyGrouper'],
function($, SelectConfiguration, DateTimePickerConfiguration, RollupConfiguration,
        ...
        MangoAPI, PointHierarchyGrouper) {
"use strict";
