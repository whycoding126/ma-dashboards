...
eventsPageController.$inject = ['$scope', '$mdMedia', '$stateParams', '$state', 'localStorageService', 'DateBar'];
function eventsPageController($scope, $mdMedia, $stateParams, $state, localStorageService, DateBar) {
