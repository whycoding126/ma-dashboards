NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "additionally alternatively api apply array attribute average basics choose dashboard data date-format default demo directive duration examples format historical input inputs interval js latest latestpointvalues madashboards mango mapointvalues milliseconds minutes moment number object operation outputs outputted parsing pass passed passing period picker point point-xid point1 point1values points pointvalues possibilities property provided pushed query querying realtime rendered returns rollup rollup-interval set starting statistical string strings supplied system text time timeout true ui-sref units update values xid"
    },
    {
      "section": "api",
